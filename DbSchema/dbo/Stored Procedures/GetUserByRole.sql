...
BEGIN  
	...
	SELECT u.UserId Id, u.[FirstName], u.LastName, u.Email, u.PhoneNumber, u.ProfileImage, u.IsActive, u.IsDeleted, 
			u.AddedOnUTC CreatedOn, Count(*) Over() AS TotalRecord  
	FROM UserDetail u
	WITH(NOLOCK)
